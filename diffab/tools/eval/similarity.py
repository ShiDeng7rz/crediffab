...
def entity_to_seq(entity):
    ...
    for res in Selection.unfold_entities(entity, 'R'):
        try:
            # print(res.resname.capitalize(), IUPACData.protein_letters_3to1.get(res.resname.capitalize(), 'X'))
            seq += IUPACData.protein_letters_3to1.get(res.resname.capitalize(), 'X')
